...
function crearChatroom(){
	...
	//var newlabel2 = $('<label></label>').text("Nombre del Creador");
	//var newinput2 = $('<input name="creator-name" type="text" class="form-control" id="creator-name"></input>');
	var newbutton = $('<button onclick="newChatroom()" name="submit" class="btn btn-primary">Crear</button>');
	
	var newform = $('<form></form>').append(newlabel1).append(newinput1).append(newbutton);
